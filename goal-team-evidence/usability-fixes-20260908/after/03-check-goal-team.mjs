...
assert.equal(crashed.data[recordKey].status, "blocked");
assert.deepEqual(crashed.data[recordKey].outcomes, {execution:'unknown', reportDelivery:'unknown', product:'unknown'});
